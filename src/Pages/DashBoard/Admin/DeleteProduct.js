...
const DeleteProduct = ({ product, refetch, setConfirmModal }) => {
    ...
    const deleteProduct = () => {
        fetch(`https://calm-anchorage-26562.herokuapp.com/deletetool/${_id}`, {
            method: 'DELETE',
            headers: {
        ...
        <div>
            ...
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    ...
                    <p className="py-2">Brand: <span className=''> {brand} pis</span></p>
                    <p className="py-2">Available Quantity:<span className='text-orange-500'> {available}</span> </p>
