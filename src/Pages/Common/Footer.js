...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-slate-900 text-base-200 lg:px-20">
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-slate-800 text-base-200 border-slate-700 lg:px-20">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Sharp Industries Ltd. <br />Providing reliable tech since 1992</p>
                </div>
