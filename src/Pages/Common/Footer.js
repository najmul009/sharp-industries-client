...
const Footer = () => {
    return (
        <div>
            <footer class="footer p-10 bg-slate-900 text-base-200 lg:px-20">
                <div>
            ...
            <footer class="footer px-10 py-4 border-t bg-slate-800 text-base-200 border-slate-700 lg:px-20">
